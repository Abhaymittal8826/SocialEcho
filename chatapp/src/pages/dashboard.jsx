...
export default function Dashboard() {
  ...
  useEffect(() => {
    axios.get('https://socialback-g9cr.onrender.com/posts/dashboard', { withCredentials: true })
      .then(res => setPosts(res.data))
      .catch(err => console.error('❌ Failed to fetch posts:', err));

    axios.get('https://socialback-g9cr.onrender.com/posts/follow-status', { withCredentials: true })
